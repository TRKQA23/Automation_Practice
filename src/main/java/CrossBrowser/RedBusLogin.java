...
public class RedBusLogin {
	...
	public static void main(String[] args) {
		...
		WebElement closeLightBox = wait
				.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//i[@class='icon-close']")));
		...
		WebElement signInWithGoogle = driver
		...
		// But the focus of selenium is still there in that new window which is just
		// closed

		driver.switchTo().window(redBusWindowId);

		// Verify whether the account has been signed in successfully by checking for
		// signout option or any other option
